...
int * alu2(int iA, int iB, int opCode, int showBits){
    int r[2];
    int status[5];
    unsigned int rslt, temp;
    switch(opCode){
        case 0:                 //RESTA
            temp = iA - iB;
            break;
    ...
    status[4] = (temp == 0);             //ZERO
    status[3] = temp > 0;                //NEGATIVE
...
int alu(int iA, int iB, int opCode, int showBits){
    int status[5];
    int rslt, temp;
    switch(opCode){
        case 0:                 //RESTA
